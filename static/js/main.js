...
var $cartQuantity, $mask, $state, common, initFooter, initHeader, jquery;
...
var $addGoodsToCartBtn, $chooseLocationBtn, $locationWord, $locations, $locationsBox, common, getSchoolList, initAddGoodsToCartBtn, initChooseLocationBtn, initLocations, jquery, knockout;
...
initLocations = function() {
  return $locations.click(function(e) {
    var building_id;
    building_id = 0;
    return jquery.ajax({
...
initAddGoodsToCartBtn = function() {
  ...
  return $addGoodsToCartBtn.click(function(e) {
    var amount, good_id;
    good_id = 0;
    amount = 1;
    if (amount < 1) {
